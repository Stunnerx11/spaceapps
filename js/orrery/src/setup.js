...
export const selectedPathMat = new THREE.LineBasicMaterial({ color: 0xffff00, linewidth: 1.5, transparent:true, opacity: 0.7 });
...
export let pathMaterials = [
    new THREE.LineBasicMaterial({ color: 0xffffff, linewidth: 1.5, transparent:true, opacity: 0.5 }),
    new THREE.LineBasicMaterial({ color: 0x000000, linewidth: 1, transparent:true, opacity: 0.35 }),
    new THREE.LineBasicMaterial({ color: 0x000000, linewidth: 1, transparent:true, opacity: 0.3 }),
    new THREE.LineBasicMaterial({ color: 0x000000, linewidth: 1, transparent:true, opacity: 0.25 }),
...
// skysphere
const textureEquirec = loader.load( 'data/8k_stars_milky_way.jpg' );
...
const sunMaterial = new THREE.MeshBasicMaterial({ map: loader.load('data/8k_sun.jpg')});
